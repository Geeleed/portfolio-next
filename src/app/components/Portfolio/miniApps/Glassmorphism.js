        ...
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div
            ...
            style={{
              ...
              background: `linear-gradient(130deg,${rgba(color, op)},${rgba(
                "#ffffff",
                op
              )},${rgba(color, op)})`,
...
// function Glassmorphism() {
//   return (
//     <div>ขณะนี้ไม่สามารถอัปโหลดขึ้น online ได้ (แต่ offline ได้) เนื่องจากยังหา bug ของ component นี้ไม่เจอ</div>
//   )
// }
