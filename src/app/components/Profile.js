  ...
  return (
    <div id='profile' className={css.main}>
      ...
      <div className={css.text}>
        ...
        <p>จบฟิสิกส์และต้องการทำงานด้าน Web Developer มีทักษะคอมพิวเตอร์เบื้องต้น ใช้ภาษา HTML CSS JavaScript React(Next.JS) ได้เบื้องต้น สามารถเชื่อมต่อจัดการข้อมูลใน database และใช้งานหรือพัฒนา API ด้วย Express/Python ในระดับเบื้องต้นได้ สามารถติดต่อได้ที่ <Link href={'mailto:surasak.kwork@gmail.com'}>surasak.kwork@gmail.com</Link> หรือ social media ที่ส่วน Contact ขอบคุณครับ</p>
        <div>
