        ...
        <div>
            <div className={css.main}>
                ...
                <div className={css.menu}>
                    ...
                    <Link href={'#'} onClick={() => setUploadPopup(<UploadPopup setUploadPopup={setUploadPopup} />)}>
                        <svg style={{ transform: 'translateY(20%) scale(1.5)' }} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-square" viewBox="0 0 16 16">
...
function UploadPopup({ setUploadPopup }) {
    return (
        <div className={css.uploadPopup}>
            <form action='https://back-portfolio-next.vercel.app/uploadApi' method='post'>
